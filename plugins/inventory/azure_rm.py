...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    def _get_hosts(self):
        ...
        for arc in self.get_option('include_arc_resource_groups'):
            self._enqueue_arc_list(vm_rg)
        ...
        for h in self._hosts:
            ...
            if 'public_ipv4_address' in h.hostvars and \
               'private_ipv4_addresses' in h.hostvars:
